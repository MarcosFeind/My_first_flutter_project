            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  title: Text(
                    '\n Using parent "Container" widget', style: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold),
                  ),
...
,
                ...
                ListTile(
                  ...
                  title: Text(
                    '\n Individual child alignment using \'Align\' widget', style: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold),
                  ),
