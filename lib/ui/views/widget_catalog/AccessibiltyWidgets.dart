      ...
      body: SingleChildScrollView(
          ...
          child: Column(
              ...
              children: [Padding(
                ...
                child: InkWell(
                  onTap: (){Navigator.pushNamed(context, RouteName.excludeSemanticsWidget);},
                  child: Container(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: InkWell(
                    onTap: (){Navigator.pushNamed(context, RouteName.mergeSemanticsWidget);},
                    child: Container(
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(11),
                          color: Colors.red
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: InkWell(
                    onTap: (){Navigator.pushNamed(context, RouteName.semanticsWidget);},
                    child: Container(
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(11),
                          color: Colors.red
