      ...
      body: SingleChildScrollView(
          ...
          child: Column(
              ...
              children: [Padding(
                ...
                child: InkWell(
                  onTap: (){Navigator.pushNamed(context, RouteName.defaultTextStyle);},
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: InkWell(
                    onTap: (){Navigator.pushNamed(context, RouteName.richText);},
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: InkWell(
                    onTap: (){Navigator.pushNamed(context, RouteName.textWidgets);},
